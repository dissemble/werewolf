  ...
  class Game
    ...
    def define_roles
      rolesets = {
        ...
        7 => ['seer', 'lumberjack', 'bodyguard', 'tanner', 'lycan', 'wolf', 'wolf'],
        8 => ['seer', 'apprentice', 'bodyguard', 'lumberjack', 'lycan', 'sasquatch', 'wolf', 'wolf'],
        9 => ['seer', 'bodyguard', 'lumberjack', 'beholder', 'apprentice', 'cultist', 'cultist', 'wolf', 'wolf'],
